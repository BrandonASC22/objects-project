...
// *this is my attempt*
let heroContainer = document.querySelector(".hero_container");
...
submitBtn.onclick = (event) => {
    ...
    let sayingElem = document.querySelector("#saying");
    ...
    let addedUser = new /**User*/(formData.name, formData.type, formData.difficulty, formData.saying);

    let userElem = addUser./**makeHTML()*/;
    let grid = docuemnt.getElementById("gridDiv");
    grid.append(userElem);
}
