...
const dVa = {
    ...
    abilities:[
        ...
        {
            name:"MICRO MISSILES",
            description:"D.Va fires a barrage of small rockets that detonate on impact, dealing damage in a limited radius around each explosion."
        },
        {
            name:"EJECT",
...
const mercy = {
    ...
    abilities:[
        ...
        },
        {
            ...
            descriptiion:"Mercy shoots a round from her sidearm. It's best reserved for emergency personal defense."
        },
        {
            name:"GUARDIAN ANGEL",
        ...
        {
            name:"VALKYRIE",
            description:"Valkyrie unleashes the full power of Mercy's Valkyrie Suit, enhancing her weapons and abilities for 15 seconds."
        }
    ]
}
